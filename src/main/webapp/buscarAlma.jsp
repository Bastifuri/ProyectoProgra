    ...
    <div class="row">
        <div class="col">
            ...
            <form action="agregarAlma" method="post">
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input id="modelo" name="modelo" type="text" class="form-control" aria-label="Sizing example input"
                           aria-describedby="inputGroup-sizing-sm" required>
                </div>
                <div class="input-group input-group-sm mb-3">
                    <span class="input-group-text">Indique la capacidad:</span>
                    <input id="capacidad" name="capacidad" type="text" class="form-control"
                ...
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input id="precio" name="precio" type="text" class="form-control" aria-label="Sizing example input"
                           aria-describedby="inputGroup-sizing-sm" required>
                </div>
                <select id="tipo" name="tipo" class="form-select form-select-sm" aria-label="Default select example"
                        required>
        ...
        <div class="col">
            ...
            <form action="buscarAlma" method="post">
                <input placeholder="Busqueda por modelo" name="modelo" type="text" class="form-control"
                       aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                <br>
                <input placeholder="Busqueda por cantidad" name="capacidad" type="text" class="form-control"
                       aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                <br>
                <input placeholder="Busqueda por el tipo" name="tipo" type="text" class="form-control"
                       aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                <br>
