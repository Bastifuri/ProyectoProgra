...
<html>
<head>
    <title>Monitores en oferta</title>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active text-light" aria-current="page" href="#" style="font-size: 20px;">PCs preensamblados</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-size: 20px;">
                        Hardware
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link active text-align text-light" aria-current="page" href="#" style="font-size: 20px;">Nosotros</a>
                </li>
            </ul>
            <!--Busqueda-->
...
<div class="catalogo">
    <div class="producto">
        <div class="row">
            <!--Este div dice que ocupe 10 de las 12 filas disponibles en pantallas de extra pequeñas, 6 en pantallas pequeñas y 4 en pantallas medianas hacia arriba-->
            <div class="col-xs-10 col-sm-6 col-md-4">
                <div class="card">
                    <img src="Catalogo/Crucial%20BX500%20SSD.jpg" alt="Disco BX500">
                    <h3>Crucial BX500 SDD</h3>
                    <span>aaaaaaaaaaaasdsaf</span>
                    <p>aaaaaaaaaaaggfgg</p>
                </div>
            </div>
    </div>
</div>
